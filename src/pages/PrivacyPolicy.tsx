      ...
      <main className="pt-32 pb-24 px-6 md:px-10 lg:px-16">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">Last updated: May 1, 2025</p>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center mb-12 gap-8">
              <div className="md:w-1/2">
                <p className="text-lg mb-6 leading-relaxed">
                  At OwnMyAI, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our AI ownership services.
                </p>
              </div>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-16">
            ...
            <section className="bg-gradient-to-br from-cyan-500/5 to-blue-500/5 p-10 rounded-3xl border border-cyan-200/20">
              <div className="flex items-start gap-4 mb-6">
                <Settings className="text-cyan-500 mt-1 h-8 w-8" />
                <h2 className="text-3xl font-bold text-cyan-600 dark:text-cyan-400 mt-0">How We Use Your Information</h2>
              </div>
              <ul className="space-y-2 text-lg">
            ...
            <section className="bg-gradient-to-br from-cyan-500/5 to-blue-500/5 p-10 rounded-3xl border border-cyan-200/20">
              <div className="flex items-start gap-4 mb-6">
                <Share2 className="text-cyan-500 mt-1 h-8 w-8" />
                <h2 className="text-3xl font-bold text-cyan-600 dark:text-cyan-400 mt-0">Information Sharing and Disclosure</h2>
              </div>
            ...
            <section className="bg-gradient-to-br from-cyan-500/5 to-blue-500/5 p-10 rounded-3xl border border-cyan-200/20">
              <div className="flex items-start gap-4 mb-6">
                <Lock className="text-cyan-500 mt-1 h-8 w-8" />
                <h2 className="text-3xl font-bold text-cyan-600 dark:text-cyan-400 mt-0">Security</h2>
              </div>
              <p className="text-lg leading-relaxed">
            ...
            <section className="bg-gradient-to-br from-cyan-500/5 to-blue-500/5 p-10 rounded-3xl border border-cyan-200/20">
              <div className="flex items-start gap-4 mb-6">
                <Bell className="text-cyan-500 mt-1 h-8 w-8" />
                <h2 className="text-3xl font-bold text-cyan-600 dark:text-cyan-400 mt-0">Your Choices</h2>
              </div>
              <p className="text-lg leading-relaxed">
            ...
            <section className="bg-gradient-to-br from-cyan-500/5 to-blue-500/5 p-10 rounded-3xl border border-cyan-200/20">
              <div className="flex items-start gap-4 mb-6">
                <Shield className="text-cyan-500 mt-1 h-8 w-8" />
                <h2 className="text-3xl font-bold text-cyan-600 dark:text-cyan-400 mt-0">Contact Us</h2>
              </div>
              <p className="text-lg leading-relaxed">
                If you have any questions about this Privacy Policy, please contact us at:
              </p>
              <a href="mailto:hello@ownmyai.info" className="text-cyan-600 hover:underline text-lg font-medium">
                hello@ownmyai.info
              </a>
            </section>
          </div>
